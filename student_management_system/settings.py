...
SECRET_KEY = 'q7%_3w@&p2+8m$^tya^zlg%o^x2b09j#nb=+69bi(8oj-+z3e@'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'main_app/static'),  # Assuming your static files live here
]
...
prod_db = dj_database_url.config(conn_max_age=500, default=f'sqlite:///{BASE_DIR / "db.sqlite3"}')
